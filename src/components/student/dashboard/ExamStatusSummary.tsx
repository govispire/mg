                ...
                <div className="relative z-10">
                    <div className="flex items-center justify-between mb-5">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h3 className="font-bold text-lg tracking-tight text-blue-600">Your Current Exams Status</h3>
                                <p className="text-xs text-muted-foreground font-medium">Tracking <span className="text-blue-600 font-bold">{activeExams.length}</span> active applications</p>
                            </div>
                        </div>
                        <Button variant="outline" size="sm" className="text-xs gap-1 h-8 shadow-md hover:shadow-lg hover:bg-blue-600 hover:border-blue-600 hover:text-white transition-all text-blue-600 border-blue-300" asChild>
                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-start mb-6">
                                        ...
                                        <span className={`text-[10px] px-2.5 py-1.5 rounded-lg font-bold border-2 shadow-sm ml-2 ${isSelected ? 'bg-gradient-to-br from-green-50 to-green-100 text-green-700 border-green-300' :
                                            isNotSelected ? 'bg-gradient-to-br from-amber-50 to-amber-100 text-amber-700 border-amber-300' : 'bg-blue-600 text-white border-blue-500'
                                            }`}>
